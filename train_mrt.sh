...
python /home/rjq/project/THUMT_ruan/thumt/bin/trainer.py \
       ...
       --parameters device_list=[2],train_steps=300000,MRT=True,batch_size=1,\
       label_smoothing=0.0,dropout=0.0,use_variational_dropout=False,learning_rate=1e-4,learning_rate_decay=none